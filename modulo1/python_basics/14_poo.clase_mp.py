...
class Persona:
    ...
    def saludar(self):
        return f"Hola, soy {self.nombre} y tengo {self.edad} años dentro del sacramiento."
...
print(ana.saludar())       # Hola, soy Ana García y tengo 28 años dentro del sacramiento.
print(luis.saludar())      # Hola, soy Luis Pérez y tengo 31 años dentro del sacramiento.
